...
/* harmony export */   "PatientDetailsViewMoreComponent": function() { return /* binding */ PatientDetailsViewMoreComponent; }
/* harmony export */ });
...
/* harmony import */ var _services_active_patients_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/active-patients.service */ 65144);
/* harmony import */ var _services_user_preference_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @services/user-preference.service */ 43909);
...
function PatientDetailsViewMoreComponent_span_36_Template(rf, ctx) { if (rf & 1) {
...
function PatientDetailsViewMoreComponent_span_37_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "span", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function PatientDetailsViewMoreComponent_span_46_Template(rf, ctx) { if (rf & 1) {
...
function PatientDetailsViewMoreComponent_div_115_Template(rf, ctx) { if (rf & 1) {
...
class PatientDetailsViewMoreComponent {
    constructor(data, service, userPreference, dialogRef) {
        this.data = data;
    ...
    ngOnInit() {
        ...
        let m_time = ((_b = this.data) === null || _b === void 0 ? void 0 : _b.hasOwnProperty('monitoringTime')) ? (_c = this.data) === null || _c === void 0 ? void 0 : _c.monitoringTime : "";
        let patchId = ((_d = this.data) === null || _d === void 0 ? void 0 : _d.hasOwnProperty('patchId')) ? (_e = this.data) === null || _e === void 0 ? void 0 : _e.patchId : "";
        this.service.getPatientBy((_f = this.data) === null || _f === void 0 ? void 0 : _f.patientId).subscribe(res => {
            var _a, _b, _c, _d, _e, _f, _g;
            this.data = res.data;
            this.data = Object.assign(Object.assign({}, this.data), { monitoringTime: m_time, patchId: patchId, age: ((_a = this.data) === null || _a === void 0 ? void 0 : _a.dob) ? this.getAge((_b = this.data) === null || _b === void 0 ? void 0 : _b.dob) : null, estimatedDischarge: (((_c = this.data) === null || _c === void 0 ? void 0 : _c.procedureDuration) && ((_d = this.data) === null || _d === void 0 ? void 0 : _d.startedOn)) ? this.getEstimatedDateForDischarge() : null });
            if ((_e = this.data) === null || _e === void 0 ? void 0 : _e.doctorId) {
            ...
            if (this.data.heightUnit.toUpperCase() !== this.userPreference.getUserHeightUnit().toUpperCase() && ((_f = this.data) === null || _f === void 0 ? void 0 : _f.height)) {
            ...
            if (this.data.weightUnit.toUpperCase() !== this.userPreference.getUserWeightUnit().toUpperCase() && ((_g = this.data) === null || _g === void 0 ? void 0 : _g.weight)) {
    ...
    getEstimatedDateForDischarge() {
        var _a, _b;
        return new Date(new Date((((_a = this.data) === null || _a === void 0 ? void 0 : _a.startedOn) * 1000) + (((_b = this.data) === null || _b === void 0 ? void 0 : _b.procedureDuration) * 60 * 1000)).toLocaleString("en-US", { timeZone: this.tz }));
    }
    getAge(dob) {
        if (dob) {
...
PatientDetailsViewMoreComponent.ɵfac = function PatientDetailsViewMoreComponent_Factory(t) { return new (t || PatientDetailsViewMoreComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MAT_DIALOG_DATA), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_services_active_patients_service__WEBPACK_IMPORTED_MODULE_2__.ActivePatientsService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_services_user_preference_service__WEBPACK_IMPORTED_MODULE_3__.UserPreferenceService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MatDialogRef)); };
PatientDetailsViewMoreComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: PatientDetailsViewMoreComponent, selectors: [["app-patient-details-view-more"]], decls: 116, vars: 62, consts: [[1, "dialog-header"], [1, "assign-header"], [1, "list-item", "ms-0"], ["mat-dialog-title", ""], [1, "patient-id"], [1, "list-item", "patient-group"], [1, "time-group"], ["mat-button", "", "mat-dialog-close", "", 1, "me-3"], [1, "mat-dialog-popup"], [1, "moreinfo-group-dialog"], [1, "row"], [1, "col-md-6", "px-1", "mb-2"], [1, "row", "align-items-center", "py-3", "mx-0"], [1, "col-sm-6"], [1, "col-sm-6", "ps-md-0", "pt-2", "pt-md-0"], [1, "fw-normal", "d-flex", "justify-content-start", "justify-content-sm-end", "text-sm-end"], ["class", "fw-normal d-flex justify-content-start justify-content-sm-end text-sm-end", 4, "ngIf"], ["class", "fw-normal d-flex justify-content-start justify-content-sm-end text-sm-end text-uppercase", 4, "ngIf"], [1, "fw-normal", "d-flex", "justify-content-start", "justify-content-sm-end", "text-sm-end", "text-uppercase"], ["class", "row", 4, "ngIf"], [1, "mx-1"], [1, "col-md-12", "px-1"], [1, "fw-normal", "d-flex", "justify-content-start", "justify-content-sm-end", "text-uppercase"]], template: function PatientDetailsViewMoreComponent_Template(rf, ctx) { if (rf & 1) {
